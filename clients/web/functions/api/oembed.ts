/**
 * oEmbed Proxy API - Cloudflare Pages Function
 *
 ...
 * For private/encrypted posts, use link-preview.ts instead.
 *
 * Endpoint: GET /api/oembed?url=https://youtube.com/watch?v=...
 */
