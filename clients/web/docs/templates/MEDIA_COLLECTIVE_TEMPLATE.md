...
- [MEDIA_COLLECTIVE.md](../visions/MEDIA_COLLECTIVE.md) - Full vision document
- [groupTemplates/types.ts](../../src/core/groupTemplates/types.ts) - Template type definitions
- [governance/types.ts](../../src/modules/governance/types.ts) - Governance types
