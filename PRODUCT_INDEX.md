...
1. **[CLAUDE.md](./CLAUDE.md)** - Project overview and instructions (START HERE)
2. **[NEXT_ROADMAP.md](./NEXT_ROADMAP.md)** - Active roadmap with prioritized epics (Epics 28-39)
3. **[COMPLETED_ROADMAP.md](./COMPLETED_ROADMAP.md)** - Archive of finished epics (Epics 1-27)
4. **[.claude/subagents.yml](./.claude/subagents.yml)** - Subagent task delegation patterns
...
**Current Status**: v1.0.0-mvp (Release Candidate)
**Completed Epics**: 1-27 (See [COMPLETED_ROADMAP.md](./COMPLETED_ROADMAP.md))
**Active Epics**: 28-39 (See [NEXT_ROADMAP.md](./NEXT_ROADMAP.md))
**Next Priority**: Epic 28 (Bug Fixes) → Epic 29 (E2E Tests) → Epic 34 (Social Features)
...
**For full index with cross-references, see sections below**
